...
public class JumpPlayer2D : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Mover character (añade aquí tu movimiento horizontal)
        Vector3 move = Vector3.zero; // tu direccción XZ
